...
TRIBUTION=YES CLANG_ENABLE_MODULES=NO MACH_O_TYPE=staticlib | xcbeautify
...
BUILD_LIBRARY_FOR_DISTRIBUTION=YES CLANG_ENABLE_MODULES=NO MACH_O_TYPE=staticlib | xcbeautify
