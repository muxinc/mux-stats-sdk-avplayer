...
- (void)monitorAVPlayerItem {
    ...
    if (currentItem) {
        ...
        [self dispatchSessionDataForAsset:currentItem.asset];
    }
}

- (void)dispatchSessionDataForAsset:(AVAsset *)asset {
    ...
    dispatch_async(dispatch_get_global_queue(QOS_CLASS_USER_INITIATED, 0), ^{
        [asset loadValuesAsynchronouslyForKeys:@[@"metadata"]
            ...
            if ([asset statusOfValueForKey:@"metadata" error:nil] != AVKeyValueStatusLoaded) {
                return;
            }
