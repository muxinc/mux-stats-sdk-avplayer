...
//        player = self.testImaSDK()
        ...
        let playerBinding = MUXSDKStats.monitorAVPlayerLayer(self.playerLayer!, withPlayerName: playName, playerData: playerData!, videoData: videoData);
