...
ENCRYPTED_DIR=$ASSETS_DIR/encrypted

INPUT_MP4_360=$ASSETS_DIR/input_360p.mp4

OUTPUT_FILE="$ENCRYPTED_DIR/index.m3u8"
...
mkdir -p $ASSETS_DIR $ENCRYPTED_DIR
...
# ffplay -allowed_extensions ALL assets/encrypted/index.m3u8
# NOTE: change the URL of key.key in the index.m3u8 before if you want to test it locally.